...
const SearchBoxParamedical = ({ setParamedicals }) => {
  ...
  const onSearchParamedical = async () => {
    ...
    try {
      ...
      // } else {
      // const response = await fetch("/professionnels/search/paramedicals", {
      //   method: "POST",
      //   header: {
      //     Accept: "application/json",
      //     "Content-type": "application/json",
      ...
      // }
      const paramedicals = await axios.post(
        "/professionnels/search/paramedicals",
        {
          wilaya: wilayaId,
          commune: communeId,
      ...
      if (paramedicals) {
        setParamedicals(paramedicals["data"]);
      }
      //dispatch(searchParamedical(wilayaId, communeId, specialiteId));
      //}
    } catch (error) {
      console.log(error);
    }
...
export default SearchBoxParamedical;
