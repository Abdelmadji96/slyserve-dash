...
// import {
//   pharmacieLoginEmail,
//   pharmacieLoginTelephone,
// } from "../../../actions/pharmacie";
// import { PHARMACIE_LOGIN_RESET } from "../../../actions/pharmacie.types";
...
const PharmacieLogin = (props) => {
  ...
  // } = useSelector((state) => state.pharmacieLoginReducer);
  // if (login) {
  //   if (successLogin) {
  //     props.history.push("/");
  //     dispatch({ type: PHARMACIE_LOGIN_RESET });
  //   }
  // }
  ...
  const onSubmit = async () => {
    if (phoneEmail !== "" && mdp !== "") {
      ...
      //   dispatch(pharmacieLoginEmail(phoneEmail, mdp));
      // } else {
      //   dispatch(pharmacieLoginTelephone(phoneEmail, mdp));
      // }
      try {
...
export default connect(null, mapDispatchProps)(PharmacieLogin);
